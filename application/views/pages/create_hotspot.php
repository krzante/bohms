...
<body>  
    ...
    <form method="POST" class="form bg mt-5" action="<?php echo base_url('hotspot/create/').$lat.'/'.$lng; ?>">
        <div class="box mt-5">
            ...
            <!-- Radius -->
            <div class="mb-3 input-group">
                <input required type="number" class="form-control" name="hotspot-radius" id="hotspot-radius" placeholder="0.0 meters" min="0" step="0.01" pattern="^\d+(?:\.\d{1,2})?$">
            </div>

            <!-- Color (Future feature) -->
            <div class="mb-3 input-group">
